...
public static final Uri CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY+"/${name}");
...
public static final Uri CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY+"/${name}/${view.Name}");
